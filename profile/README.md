...
Four projects that build and improve each other. The tooling repo improves the product repo, and building the product exposes what the tooling needs next.
